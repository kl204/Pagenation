...
${param.flag=='loginPlz'?"<script>alert('로그인이 필요합니다!');</script>":""}
...
<table>
	<tbody>
		...
		<tr>			
			<td><input type="text" name="id" placeholder="아이디를 입력하시오" /><br>
			<input type="text" name="pass" placeholder="비밀번호를 입력하시오" /><br>
